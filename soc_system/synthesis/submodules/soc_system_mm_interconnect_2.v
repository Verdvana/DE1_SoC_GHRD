...
module soc_system_mm_interconnect_2 (
	...
	wire  [115:0] alt_vip_vfr_0_avalon_slave_agent_rp_data;                       // alt_vip_vfr_0_avalon_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] button_pio_s1_agent_rp_data;                                    // button_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] uart_0_s1_agent_rp_data;                                        // uart_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] spi_0_spi_control_port_agent_rp_data;                           // spi_0_spi_control_port_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] cmd_mux_src_data;                                               // cmd_mux:src_data -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                              // alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire    [4:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_channel;       // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_channel -> alt_vip_vfr_0_avalon_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_001_src_channel;                                        // cmd_mux_001:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_002_src_data;                                           // cmd_mux_002:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                          // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                        // cmd_mux_002:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_003_src_valid;                                          // cmd_mux_003:src_valid -> uart_0_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                           // cmd_mux_003:src_data -> uart_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                          // uart_0_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                        // cmd_mux_003:src_channel -> uart_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                  // cmd_mux_003:src_startofpacket -> uart_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                    // cmd_mux_003:src_endofpacket -> uart_0_s1_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] uart_0_s1_burst_adapter_source0_channel;                        // uart_0_s1_burst_adapter:source0_channel -> uart_0_s1_agent:cp_channel
	...
	wire          cmd_mux_004_src_valid;                                          // cmd_mux_004:src_valid -> spi_0_spi_control_port_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                           // cmd_mux_004:src_data -> spi_0_spi_control_port_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                          // spi_0_spi_control_port_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                        // cmd_mux_004:src_channel -> spi_0_spi_control_port_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                  // cmd_mux_004:src_startofpacket -> spi_0_spi_control_port_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                    // cmd_mux_004:src_endofpacket -> spi_0_spi_control_port_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] spi_0_spi_control_port_burst_adapter_source0_channel;           // spi_0_spi_control_port_burst_adapter:source0_channel -> spi_0_spi_control_port_agent:cp_channel
	...
	wire  [115:0] cmd_demux_001_src0_data;                                        // cmd_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [115:0] crosser_001_out_data;                                           // crosser_001:out_data -> cmd_mux:sink1_data
	...
	wire  [115:0] rsp_demux_src1_data;                                            // rsp_demux:src1_data -> crosser_003:in_data
	wire          rsp_demux_src1_ready;                                           // crosser_003:in_ready -> rsp_demux:src1_ready
	wire    [4:0] rsp_demux_src1_channel;                                         // rsp_demux:src1_channel -> crosser_003:in_channel
	...
	wire  [115:0] crosser_003_out_data;                                           // crosser_003:out_data -> rsp_mux_001:sink0_data
	wire          crosser_003_out_ready;                                          // rsp_mux_001:sink0_ready -> crosser_003:out_ready
	wire    [4:0] crosser_003_out_channel;                                        // crosser_003:out_channel -> rsp_mux_001:sink0_channel
	...
	wire          uart_0_s1_agent_rdata_fifo_out_valid;                           // uart_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] uart_0_s1_agent_rdata_fifo_out_data;                            // uart_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          uart_0_s1_agent_rdata_fifo_out_ready;                           // avalon_st_adapter_003:in_0_ready -> uart_0_s1_agent_rdata_fifo:out_ready
	...
	wire          spi_0_spi_control_port_agent_rdata_fifo_out_valid;              // spi_0_spi_control_port_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] spi_0_spi_control_port_agent_rdata_fifo_out_data;               // spi_0_spi_control_port_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          spi_0_spi_control_port_agent_rdata_fifo_out_ready;              // avalon_st_adapter_004:in_0_ready -> spi_0_spi_control_port_agent_rdata_fifo:out_ready
