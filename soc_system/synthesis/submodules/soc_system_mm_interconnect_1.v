...
module soc_system_mm_interconnect_1 (
	...
	wire  [115:0] sysid_qsys_control_slave_agent_rp_data;                         // sysid_qsys_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [115:0] led_pio_s1_agent_rp_data;                                       // led_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] button_pio_s1_agent_rp_data;                                    // button_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] uart_0_s1_agent_rp_data;                                        // uart_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] spi_0_spi_control_port_agent_rp_data;                           // spi_0_spi_control_port_agent:rp_data -> router_007:sink_data
	...
	wire    [5:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire    [5:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_channel;       // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_channel -> alt_vip_vfr_0_avalon_slave_agent:cp_channel
	...
	wire  [115:0] cmd_mux_001_src_data;                                           // cmd_mux_001:src_data -> sysid_qsys_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                          // sysid_qsys_control_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                        // cmd_mux_001:src_channel -> sysid_qsys_control_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_002_src_data;                                           // cmd_mux_002:src_data -> led_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                          // led_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                        // cmd_mux_002:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                           // cmd_mux_003:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                          // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                        // cmd_mux_003:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_004_src_valid;                                          // cmd_mux_004:src_valid -> uart_0_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                           // cmd_mux_004:src_data -> uart_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                          // uart_0_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                        // cmd_mux_004:src_channel -> uart_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                  // cmd_mux_004:src_startofpacket -> uart_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                    // cmd_mux_004:src_endofpacket -> uart_0_s1_burst_adapter:sink0_endofpacket
	...
	wire    [5:0] uart_0_s1_burst_adapter_source0_channel;                        // uart_0_s1_burst_adapter:source0_channel -> uart_0_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                           // cmd_mux_005:src_data -> spi_0_spi_control_port_burst_adapter:sink0_data
	...
	soc_system_mm_interconnect_1_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
